...
class io_file64_plus_t(Structure):
    _fields_ = [
        ("_p1", c_uint64),
        ("_p2", c_uint64),
        ("_IO_file_finish", c_void_p),
        ("_IO_file_overflow", c_void_p),
        ("_IO_file_underflow", c_void_p),
        ("_IO_default_uflow", c_void_p),
        ("_IO_default_pbackfail", c_void_p),
        ("_IO_file_xsputn", c_void_p),
        ("_IO_Unk1", c_void_p),
        ("_IO_file_seekoff", c_void_p),
        ("_IO_Unk1", c_void_p),
        ("_IO_file_setbuf", c_void_p),
        ("_IO_file_sync", c_void_p),
        ("_IO_file_doallocate", c_void_p),
        ("_IO_file_read", c_void_p),
        ("_IO_file_write", c_void_p),
        ("_IO_file_seek", c_void_p),
        ("_IO_file_close", c_void_p),
        ("_IO_file_stat", c_void_p),
    ]
