...
from typing import (IO, TYPE_CHECKING, Any, ByteString, Callable, Dict,
                    Generator, Iterator, List, Optional, Sequence, Tuple, Type,
                    Union)
...
def process_lookup_path(name: str, perm: Permission = Permission.ALL) -> Optional[Section]: ...  # type: ignore
...
def keystone_assemble(code_str: str, arch: int, mode: int, **kwargs: Any) -> Optional[Union[str, bytearray]]: ...
